...
INSERT INTO `admin` (`id`, `username`, `password`, `realname`, `group_id`, `email`, `qq`, `notebook`, `mobile`, `telephone`, `last_login_ip`, `last_login_time`, `login_count`, `status_is`, `create_time`) VALUES
(1, 'admin', '54f8350c9ced3646d68689030ad13685', '', 1, '755213779@qq.com', '0', NULL, '', '', '127.0.0.1', 1396765699, 1, 'Y', 1396765678);
...
INSERT INTO `eio` (`id`, `typeid`, `classifyid`, `icon`, `title`, `author`, `describe`, `questioncount`, `levelA`, `levelB`, `levelC`, `levelD`, `didcount`, `praisecount`, `stampcount`, `publishtime`, `uptime`) VALUES
(1, 2, 1, '', '测试问卷1', 'linwei', '测试描述', 3, '等级A', '等级B', '等级C', '等级D', 25, 7, 8, '2013-12-08 12:54:07', '2014-01-26 07:12:33'),
...
CREATE TABLE IF NOT EXISTS `eiotype` (
  ...
  `cnname` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `uptime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
INSERT INTO `eiotype` (`id`, `typename`, `cnname`, `uptime`) VALUES
(1, 'SimpleSelectQuestion', '单选题', '2014-04-10 14:26:08'),
(2, 'InputQuestion', '填空题', '2014-04-10 14:26:14'),
(3, 'MultiSelectQuestion', '多选题', '2014-04-10 14:26:18');
...
CREATE TABLE IF NOT EXISTS `microblog` (
  ...
  `uptime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='说说表' AUTO_INCREMENT=80 ;
...
(79, 1, 'james 今日已签到,成功获得1积分', '2014-02-28 02:45:04');
...
(1, 1, '2014-02-28 02:58:50'),
(1, 0, '2014-02-28 03:10:51');
...
(1, 'james', 'james', 'james', '', 0, '2013-12-04', 'huashengdun', 0, 1, 66, '2014-01-04 10:26:14'),
...
(5, 'testcms', 'linwei', '', '', 0, '2014-04-04', '', 0, 0, 0, '2014-04-06 07:44:50');
